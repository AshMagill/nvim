...
function M.getLogs()
        local logsPath
    local logsOption = vim.fn.inputlist({"1. Workflow", "2. Workspace"})
    if logsOption == 1 then
        logsPath = "/home/ash/Documents/Workflow"
    elseif logsOption == 2 then
        logsPath = "/home/ash/Workspace"
    else
